...
import { D as IconUtils, O as ObjectUtils, T as DomHandler, b as PrimeReact, c as useMergeProps, g as useUpdateEffect, h as useUnmountEffect, j as classNames, l as useMountEffect, n as useHandleStyle, t as ComponentBase, x as PrimeReactContext } from "./componentbase.esm-1WgDljvG.js";
...
var InputNumber = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var metaData = _objectSpread(_objectSpread({ props }, props.__parentMetadata), {}, { state: { focused: focusedState } });
	...
	var constructParser = function constructParser() {
		...
		var numerals = _toConsumableArray(new Intl.NumberFormat(_locale, { useGrouping: false }).format(9876543210)).reverse();
	...
	*/
	...
	var getDecimalExpression = function getDecimalExpression() {
		var formatter = new Intl.NumberFormat(_locale, _objectSpread(_objectSpread({}, getOptions()), {}, { useGrouping: false }));
	...
	var isFloat = function isFloat(val) {
		var parseVal = parseValue(new Intl.NumberFormat(_locale, getOptions()).format(val));
	...
	var createInputElement = function createInputElement() {
		...
		return /* @__PURE__ */ import_react.createElement(InputText, _extends({
			ref: inputRef,
			id: props.inputId,
	...
	var createUpButton = function createUpButton() {
		...
		var upButton = IconUtils.getJSXIcon(icon, _objectSpread({}, incrementIconProps), { props });
	...
	var createDownButton = function createDownButton() {
		...
		var downButton = IconUtils.getJSXIcon(icon, _objectSpread({}, decrementIconProps), { props });
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("span", _extends({ ref: elementRef }, rootProps), inputElement, buttonGroup), hasTooltip && /* @__PURE__ */ import_react.createElement(Tooltip, _extends({
		target: elementRef,
...
//# sourceMappingURL=inputnumber.esm-CmxbKstJ.js.map