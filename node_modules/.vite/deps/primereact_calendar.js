...
import { A as ZIndexUtils, C as localeOption, D as IconUtils, M as mask, O as ObjectUtils, T as DomHandler, a as useDisplayOrder, b as PrimeReact, c as useMergeProps, f as usePrevious, g as useUpdateEffect, h as useUnmountEffect, j as classNames, k as UniqueComponentId, l as useMountEffect, n as useHandleStyle, r as ESC_KEY_HANDLING_PRIORITIES, s as useGlobalOnEscapeKey, t as ComponentBase, u as useOverlayListener, w as localeOptions, x as PrimeReactContext } from "./componentbase.esm-1WgDljvG.js";
...
var Calendar = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var _React$useState10 = _slicedToArray(import_react.useState("date"), 2), currentView = _React$useState10[0], setCurrentView = _React$useState10[1];
	var _React$useState12 = _slicedToArray(import_react.useState(null), 2), currentMonth = _React$useState12[0], setCurrentMonth = _React$useState12[1];
	var _React$useState14 = _slicedToArray(import_react.useState(null), 2), currentYear = _React$useState14[0], setCurrentYear = _React$useState14[1];
	var _React$useState16 = _slicedToArray(import_react.useState([]), 2), yearOptions = _React$useState16[0], setYearOptions = _React$useState16[1];
	...
	var isValidSelection = function isValidSelection(value) {
		...
		if (isSingleSelection()) {
			if (!(isSelectable(value.getDate(), value.getMonth(), value.getFullYear(), false) && isSelectableTime(value))) isValid = false;
			...
			if (props.minDate.getHours() > value.getHours()) validMin = false;
				...
				if (props.minDate.getMinutes() > value.getMinutes()) validMin = false;
					...
					if (props.minDate.getSeconds() > value.getSeconds()) validMin = false;
						...
						if (props.minDate.getMilliseconds() > value.getMilliseconds()) validMin = false;
					}
				}
			}
		}
			...
			if (props.maxDate.getHours() < value.getHours()) validMax = false;
				...
				if (props.maxDate.getMinutes() < value.getMinutes()) validMax = false;
					...
					if (props.maxDate.getSeconds() < value.getSeconds()) validMax = false;
						...
						if (props.maxDate.getMilliseconds() < value.getMilliseconds()) validMax = false;
					}
				}
			}
		}
