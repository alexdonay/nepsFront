...
import { A as ZIndexUtils, C as localeOption, D as IconUtils, O as ObjectUtils, S as ariaLabel, T as DomHandler, b as PrimeReact, c as useMergeProps, f as usePrevious, g as useUpdateEffect, h as useUnmountEffect, i as useDebounce, j as classNames, l as useMountEffect, m as useStyle, n as useHandleStyle, o as useEventListener, p as useResizeListener, t as ComponentBase, u as useOverlayListener, x as PrimeReactContext, y as FilterService } from "./componentbase.esm-1WgDljvG.js";
import { t as IconBase } from "./iconbase.esm-CBfdkoRW.js";
import { t as SpinnerIcon } from "./index.esm-DMCYAVy1.js";
import { t as Ripple } from "./ripple.esm-BlTJnMYS.js";
import { t as Portal } from "./portal.esm-D79ADs_q.js";
import { t as Tooltip } from "./tooltip.esm-pPU4HW_D.js";
import { n as ChevronDownIcon, t as ChevronUpIcon } from "./index.esm-BSvrI_Lo.js";
...
import { t as TimesIcon } from "./index.esm-PhhJ_PCV.js";
import { t as CheckIcon } from "./index.esm-ClY8XfPk.js";
...
var VirtualScroller = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var _React$useState2 = _slicedToArray$1(import_react.useState(both ? {
		rows: 0,
		cols: 0
	} : 0), 2), firstState = _React$useState2[0], setFirstState = _React$useState2[1];
	var _React$useState4 = _slicedToArray$1(import_react.useState(both ? {
		rows: 0,
		cols: 0
	} : 0), 2), lastState = _React$useState4[0], setLastState = _React$useState4[1];
	var _React$useState6 = _slicedToArray$1(import_react.useState(0), 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
	var _React$useState8 = _slicedToArray$1(import_react.useState(both ? {
		rows: 0,
		cols: 0
	} : 0), 2), numItemsInViewportState = _React$useState8[0], setNumItemsInViewportState = _React$useState8[1];
	var _React$useState10 = _slicedToArray$1(import_react.useState(props.numToleratedItems), 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
	var _React$useState12 = _slicedToArray$1(import_react.useState(props.loading || false), 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
	var _React$useState14 = _slicedToArray$1(import_react.useState([]), 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
	...
	var bindWindowResizeListener = _slicedToArray$1(useResizeListener({
		listener: function listener(event) {
			return onResize();
		},
		when: !props.disabled
	}), 1)[0];
	var bindOrientationChangeListener = _slicedToArray$1(useEventListener({
		target: "window",
	...
	var setContentPosition = function setContentPosition(pos) {
		if (_contentRef.current && !props.appendOnly) {
			...
			var setTransform = function setTransform() {
				...
				contentStyle.current = _objectSpread$3(_objectSpread$3({}, contentStyle.current), { transform: "translate3d(".concat(_x, "px, ").concat(_y, "px, 0)") });
			};
	...
	var createLoader = function createLoader() {
		...
		var icon = props.loadingIcon || /* @__PURE__ */ import_react.createElement(SpinnerIcon, _extends$1({}, loadingIconProps, { spin: true }));
		var loadingIcon = IconUtils.getJSXIcon(icon, _objectSpread$3({}, loadingIconProps), { props });
...
var DropdownItem = /* @__PURE__ */ import_react.memo(function(props) {
	...
	return /* @__PURE__ */ import_react.createElement("li", _extends({ key: props.label }, itemProps), checkmark && function iconRenderer() {
		if (selected) {
...
var DropdownPanel = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(props, ref) {
	...
	var getPTOptions = function getPTOptions(key, options) {
		return ptm(key, _objectSpread$1({ hostName: props.hostName }, options));
	};
	...
	var createItem = function createItem(option, index) {
		...
		if (option.group && props.optionGroupLabel) {
			...
			return /* @__PURE__ */ import_react.createElement("li", _extends({ key }, itemGroupProps), /* @__PURE__ */ import_react.createElement("span", itemGroupLabelProps, groupContent));
		}
	...
	var createFilterClearIcon = function createFilterClearIcon() {
		if (props.showFilterClear && props.filterValue) {
			...
			return IconUtils.getJSXIcon(icon, _objectSpread$1({}, clearIconProps), { props });
		}
		return null;
	};
	var createFilter = function createFilter() {
		if (props.filter) {
			...
			var filterIcon = IconUtils.getJSXIcon(icon, _objectSpread$1({}, filterIconProps), { props });
	...
	var createContent = function createContent() {
		if (props.virtualScrollerOptions) {
			var virtualScrollerProps = _objectSpread$1(_objectSpread$1({}, props.virtualScrollerOptions), {
				style: _objectSpread$1(_objectSpread$1({}, props.virtualScrollerOptions.style), { height: props.scrollHeight }),
				className: classNames("p-dropdown-items-wrapper", props.virtualScrollerOptions.className),
				items: props.visibleOptions,
				autoSize: true,
				onLazyLoad: function onLazyLoad(event) {
					return props.virtualScrollerOptions.onLazyLoad(_objectSpread$1(_objectSpread$1({}, event), { filter: props.filterValue }));
				},
			...
			return /* @__PURE__ */ import_react.createElement(VirtualScroller, _extends({ ref: props.virtualScrollerRef }, virtualScrollerProps, { pt: ptm("virtualScroller") }));
		}
		var items = createItems();
	...
	var element = function createElement() {
		...
		return /* @__PURE__ */ import_react.createElement(CSSTransition, _extends({ nodeRef: ref }, transitionProps), /* @__PURE__ */ import_react.createElement("div", _extends({ ref }, panelProps), props.firstFocusableElement, filter, content, footer, props.lastFocusableElement));
	}();
...
var Dropdown = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var _useDebounce2 = _slicedToArray(useDebounce("", props.filterDelay || 0), 3), filterValue = _useDebounce2[0], filterState = _useDebounce2[1], setFilterState = _useDebounce2[2];
	...
	var _React$useState4 = _slicedToArray(import_react.useState(-1), 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
	var _React$useState6 = _slicedToArray(import_react.useState(false), 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
	...
	var _DropdownBase$setMeta = DropdownBase.setMetaData(_objectSpread(_objectSpread({ props }, props.__parentMetadata), {}, { state: {
		filter: filterState,
			...
			if (props.optionGroupLabel) {
				...
				try {
					for (_iterator.s(); !(_step = _iterator.n()).done;) {
						...
						if (filteredSubOptions && filteredSubOptions.length) filteredGroups.push(_objectSpread(_objectSpread({}, optgroup), _defineProperty({}, "".concat(props.optionGroupChildren), filteredSubOptions)));
					}
				} catch (err) {
					_iterator.e(err);
				} finally {
	...
	var onArrowLeftKey = function onArrowLeftKey(event) {
		arguments.length > 1 && arguments[1] !== void 0 && arguments[1] && setFocusedOptionIndex(-1);
	};
	...
	var createClearIcon = function createClearIcon() {
		if (props.value != null && props.showClear && !props.disabled && !ObjectUtils.isEmpty(props.options)) {
			...
			return IconUtils.getJSXIcon(icon, _objectSpread({}, clearIconProps), { props });
		}
		return null;
	};
	...
	var createDropdownIcon = function createDropdownIcon() {
		...
		var dropdownIcon = IconUtils.getJSXIcon(icon, _objectSpread({}, dropdownIconProps), { props });
		var ariaLabel = props.placeholder || props.ariaLabel;
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, /* @__PURE__ */ import_react.createElement(DropdownPanel, _extends({
		hostName: "Dropdown",
		ref: overlayRef,
		visibleOptions,
		virtualScrollerRef
...
//#endregion
export { VirtualScroller as n, Dropdown as t };

//# sourceMappingURL=dropdown.esm-DOt0prmM.js.map