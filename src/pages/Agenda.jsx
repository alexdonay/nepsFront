            ...
            <div className="grid">
              <div className="col-4">
                <div className="surface-100 p-3 border-round">
                  <strong>Manhã</strong>
                  <p>{loc.morning_students?.length || 0}/{loc.morning_slots}</p>
                </div>
              </div>
              <div className="col-4">
                <div className="surface-100 p-3 border-round">
                  <strong>Tarde</strong>
                  <p>{loc.afternoon_students?.length || 0}/{loc.afternoon_slots}</p>
                </div>
              </div>
              <div className="col-4">
                <div className="surface-100 p-3 border-round">
                  <strong>Noite</strong>
                  <p>{loc.evening_students?.length || 0}/{loc.evening_slots}</p>
                </div>
              </div>
            </div>
          </div>
